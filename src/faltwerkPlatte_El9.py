...
def main():
   ...
   nx = 10 # nr. of vertically aligned shells in y direction (x=const.)
   ny = 10 # nr. of vertically aligned shells in x direction (y=const.)
   ...
   hx = 6 # elements between two vertical shells (x direction) // total elements in x-direction if nx <= 1
   hy = 6 # elements between two vertical shells (y direction) // total elements in y-direction if ny <= 1
   ...
   t = 0.2     # shell thickness
   e = 21000   # Young's modulus
   v = 0       # Poisson ratio
   ...
   header = Header("Schalen Sandwich Mikroelement El9", ('','','',3,6,4), solv=4)
   
   
   # Draufsicht
   #footer = Footer(tie=True, macr=('epsq,,1','plot,rot1,0', 'plot,rot3,0', 'plot,mesh', 'plot,axis', 'plot,boun,,1', 'plot,boun,,2', 'plot,boun,,3', 'plot,load'), macrBlanks=0 )
   
   # schräge Ansicht
   footer = Footer(tie=True, macr=('epsq,,1','plot,rot1,-60', 'plot,rot3,30', 'plot,mesh', 'plot,axis', 'plot,boun,,1', 'plot,boun,,2', 'plot,boun,,3', 'plot,load'), macrBlanks=0 )
   
   filename = "C:/FG/feap/exe/rve/microShell/iFaltwerkNEUEl9"
